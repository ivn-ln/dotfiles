...
theme.notification_border_color = "#94E2D5"
theme.notification_border_width = dpi(5)
--theme.notification_shape = gears.shape.rounded_rect(cr, 70, 70, 8)
...
theme.wallpaper = themes_path.."/home/illarn/Wallpaper/darker_unicat.png"
